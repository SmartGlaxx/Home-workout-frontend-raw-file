        ...
        <Grid className="topCenter" item xs ={false} sm={5}>
            <div className="topCenter-inner">
                <ul className="topCenter-ul">
                    ...
                    <Link to={`/workout-session/${fitnessLevel}`}
                    className={window.location.href.indexOf("workout-session") > -1 ? `topCenter-li-active` :`topCenter-li` } >
                        <li >
                            <FaPersonRunning 
                            className= {window.location.href.indexOf("workout-session") > -1 ? `top-icons-active` :`top-icons` }
                            size='25'/>
                        </li>
                    </Link>
                    <Link to={`/report/${id}`}
