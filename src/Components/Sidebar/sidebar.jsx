        ...
        <div className="sideTop" >
            <div className="sideTop-inner">
                <ul className="sideTop-ul">
                    ...
                    <li className="sideTop-li" onClick={openSidebar}>
                    <Link to={`/workout-session/${fitnessLevel}`} className='left-nav' >
                    <div className= {window.location.href.indexOf("workout-session") > -1 ? `sideTop-li-inner-active` :`sideTop-li-inner ` }>
                    <FaPersonRunning className= {window.location.href.indexOf("workout-session") > -1 ? `icons-active` :`icons`} size='15'/>
                        Workout Session</div>
                    </Link>
                    </li>
                    <li className="sideTop-li" onClick={openSidebar}>
