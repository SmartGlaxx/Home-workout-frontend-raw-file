...
//                 <button className='auth-signin-btn-main' onClick={signIn}>Sign in</button>
//               </div>
  ...
  const signIn = async (e) => {
    try {
      ...
      if (!emailOrUsername || !password) {
        setError({
          status: true,
          msg: 'Please enter E-mail or Username and Password',
        });
        setTimeout(() => {
          setError({ status: false, msg: '' });
        }, 4000);
    ...
    <Grid container className="signin">
      ...
      <Grid item xs={12} sm={6}  className="signin-heading">
        <h2 className="signin-heading-title">
          Home Workout <br/>
          <span className='signin-heading-title-center'>and</span><br/> 
